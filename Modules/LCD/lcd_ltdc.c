...
#else
    uint16_t ltdc_lcd_framebuf[1280][800] __attribute__((section(".sdram_data")));   /* 定义最大屏分辨率时,LTDC所需的帧缓存数组大小 */
 ...
 * @param       pllsaidivr   :LTDC时钟分频系数,取值范围:RCC_PLLSAIDIVR_2/4/8/16,对应分频2~16 
...
//    ltdc_layer_parameter_config(1, (uint32_t)g_ltdc_framebuf[1], LTDC_PIXFORMAT, 127, 0, 6, 7, 0X000000);/* 第二层参数配置 */
