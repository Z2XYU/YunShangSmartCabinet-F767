...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "../../Middlewares/MALLOC/malloc.h"   /*Header for the dynamic memory function*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(my_font_chinese_40) // 声明字体
