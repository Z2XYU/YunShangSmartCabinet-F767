...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_label_1, "YunShang_IOT");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 192, 59);
    lv_obj_set_size(ui->screen_label_1, 416, 66);

    //Write style for screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_AlexBrush_Regular_40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_2, "系统加载中...");
    lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_2, 294, 284);
    lv_obj_set_size(ui->screen_label_2, 212, 23);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_simsun_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_anim_time(ui->screen_bar_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->screen_YunShang_City, "0:/YunShang_IoT_Platform/image/YunShang_City.bin");
    ...
    //Write codes screen_YunShang_IOT_log
    ui->screen_YunShang_IOT_log = lv_img_create(ui->screen);
    lv_obj_add_flag(ui->screen_YunShang_IOT_log, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_YunShang_IOT_log, "0:/YunShang_IoT_Platform/image/YunShang_IOT_log.bin");
    lv_img_set_pivot(ui->screen_YunShang_IOT_log, 50,50);
    lv_img_set_angle(ui->screen_YunShang_IOT_log, 0);
    lv_obj_set_pos(ui->screen_YunShang_IOT_log, 632, 23);
    lv_obj_set_size(ui->screen_YunShang_IOT_log, 142, 100);

    //Write style for screen_YunShang_IOT_log, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->screen_YunShang_IOT_log, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_YunShang_IOT_log, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_YunShang_IOT_log, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_YunShang_IOT_log, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_image1
    ui->screen_image1 = lv_img_create(ui->screen);
    lv_obj_add_flag(ui->screen_image1, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_image1,  "0:/YunShang_IoT_Platform/image/image1.bin");
    ...
    //lv_img_set_src(ui->screen_image2, "0:/YunShang_IoT_Platform/image/image2.bin");
